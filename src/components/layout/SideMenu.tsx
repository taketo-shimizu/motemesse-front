...
export default function SideMenu() {
  ...
  return (
    <>
      ...
      <div
        id="settingsPanel"
        className={`grid grid-rows-[auto_1fr_auto] fixed left-0 top-0 h-full w-80 bg-white shadow-2xl z-50 transition-transform duration-300 ${
          ...
          <div className="p-4 bg-gray-50 rounded-2xl">
            ...
            <div className="flex space-x-2">
              <button
                ...
                className={`flex-1 py-2.5 px-4 rounded-full text-xs font-medium transition-all ${
                  user?.tone === 0
